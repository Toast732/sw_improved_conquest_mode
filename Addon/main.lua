...
require("libraries.addonLocationUtils") -- functions for addon locations and environment mods
...
require("libraries.executionQueue") -- functions for queuing functions for conditions to be met.
